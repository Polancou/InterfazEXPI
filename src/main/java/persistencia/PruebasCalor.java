 ...
 */
@MappedSuperclass
@Table(name = "pruebas_calor")
@XmlRootElement
public class PruebasCalor implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "calor")
    private List<PruebasTermicas> pruebasTermicasList;

    public PruebasCalor() {
    }

    public PruebasCalor(Integer id) {
        this.id = id;
    }

    public PruebasCalor(Integer id, String organo, String normal, String fugaz, String ninguno, String persistente, String incremento, String irradiado, String drecremento) {
        this.id = id;
        this.organo = organo;
        this.normal = normal;
        this.fugaz = fugaz;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PruebasCalor)) {
            return false;
        }
        PruebasCalor other = (PruebasCalor) object;
    ...
    public String toString() {
        return "persistencia.PruebasCalor[ id=" + id + " ]";
    }
