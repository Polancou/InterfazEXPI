...
public class Dolor implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "dolor")
    private List<ExamenOral> examenOralList;

    public Dolor() {
    }

    public Dolor(Integer id) {
        this.id = id;
    }

    public Dolor(Integer id, int siNo, String organo, int ubicacion, Date duracion, int estimulo) {
        this.id = id;
        this.siNo = siNo;
        this.organo = organo;
    ...
    public String toString() {
        return "persistencia.Dolor[ id=" + id + " ]";
    }
